...
import { text_calculator } from './TextContent';
...
const AdministratorSettingsCalculat = () => {
  ...
  const auctions = (
    <Grid container spacing={1}>
      ...
      <Grid item xs={4}>
        <TextField fullWidth type='number' size='small' label={text_calculator.carPrice} />
      </Grid>
      <Grid item xs={4}>
        <Button className='buttonSend' variant='outlined' fullWidth>
          save
              ...
              <Grid container spacing={2}>
                ...
                <Grid item xs={12}>
                  <Autocomplete
                    ...
                    renderInput={(params) => <TextField label={text_calculator.selectLocation} {...params} />}
                  />
                </Grid>
                {text_calculator.selectCarType.map((index) => (
                  <Grid item xs={12}>
